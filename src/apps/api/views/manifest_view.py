        ...
        'manifest_rows': [
            {
                ...
                'description': 'Sample data created by the Collaborative OPen Omics (COPO) team using community-defined metadata standards',
            },
            {
                'prefix': 'enaSamples',
                'label_prefix': 'ENA',
                ...
                'description': 'Samples derived from checklists defined by the European Nucleotide Archive (ENA)',
            },
            {
                'prefix': 'tolSamples',
                'label_prefix': 'ToL',
                'label_suffix': 'samples',
                'title': 'Tree of Life',
                'description': 'Sample information based on projects within the Tree of Life (ToL) initiative',
            },
            {
                'prefix': 'enaBarcode',
                'label_prefix': 'ENA',
                ...
                'title': 'European Nucleotide Archive',
                'is_header': True,
                'description': 'Annotated sequence data of specific genetic markers or features derived from the European Nucleotide Archive (ENA)',
            },
            {
                'prefix': 'copoRead',
                'label_prefix': 'COPO',
                ...
                'title': 'Collaborative OPen Omics',
                'is_header': True,
                'description': 'Sequencing data of DNA or RNA fragments generated by sequencing instruments created by the Collaborative OPen Omics (COPO) team based on community-defined metadata standards',
            },
            {
                'prefix': 'enaRead',
                'label_prefix': 'ENA',
                'label_suffix': 'reads',
                'title': 'European Nucleotide Archive',
                'description': 'Unprocessed sequencing data of DNA or RNA fragments generated by sequencing instruments, derived from datasets submitted to the European Nucleotide Archive (ENA)',
            },
            {
                'prefix': 'rembiImages',
                ...
                'title': '',
                'is_header': True,
                'description': 'Image data based on the REcommended Metadata for Biological Images (REMBI) standard',
            },
            {
            ...
            },
            {
                ...
                'title': '',
                'is_header': True,
                'description': 'Analysis of genomic or transcriptomic content of individual cells to reveal cellular differences within a population',
            },
        ]
    }
...
def auto_adjust_excel_column_width(dataframe, pandas_writer, sheet_name):
    for column in dataframe:
        column_length = max(dataframe[column].fillna('').astype(str).map(len).max(), len(column))
...
def apply_dropdown_list(
    ...
    for column_name in dataframe:
        column_length = max(
            dataframe[column_name].fillna('').astype(str).map(len).max(), len(column_name)
        )
