...
(async () => {
    ...
    }
    {
        ...
        await puppeteer.Locator.race([
            targetPage.locator('::-p-aria(Associated profile types[role=\\"link\\"])'),
            targetPage.locator('tr.model-associatedprofiletype > th > a'),
            targetPage.locator('::-p-xpath(//*[@id=\\"nav-sidebar\\"]/div[4]/table/tbody/tr[1]/th/a)'),
            targetPage.locator(':scope >>> tr.model-associatedprofiletype > th > a'),
            targetPage.locator('::-p-text(Associated profile types)')
        ])
            .setTimeout(timeout)
    ...
    }
    {
        const targetPage = page;
        await puppeteer.Locator.race([
            targetPage.locator('::-p-aria(testuser)'),
             targetPage.locator('::-p-xpath(//*[@id=\\"id_users\\"]/option[normalize-space(.)=\"testuser\"])'),
        ])
            .setTimeout(timeout)
            .click({
              offset: {
    ...
    }
    {
        ...
        await puppeteer.Locator.race([
            ...
            targetPage.locator('::-p-xpath(//*[@id=\\"associatedprofiletype_form\\"]/div/div/input[1])'),
